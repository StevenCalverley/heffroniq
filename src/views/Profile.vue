        ...
        <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
          <aside class="py-6 lg:col-span-3">
            <nav>
              ...
              <a href="#" class="bg-light-blue-50 border-light-blue-500 text-light-blue-700 hover:bg-light-blue-100 hover:text-light-blue-800 group border-l-4 px-3 py-2 flex items-center text-sm font-medium" aria-current="page">
                <!-- Current: "text-teal-500 group-hover:text-teal-500", Default: "text-gray-400 group-hover:text-gray-500" -->
                <!-- Heroicon name: outline/user-circle -->
                <svg class="text-light-blue-500 group-hover:text-light-blue-600 flex-shrink-0 -ml-1 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              ...
              <div class="mt-6 flex flex-col lg:flex-row">
                ...
                <div class="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-grow-0 lg:flex-shrink-0">
                  ...
                  <div class="mt-1 lg:hidden">
                    <div class="flex items-center">
                      <div class="flex-shrink-0 inline-block rounded-full overflow-hidden h-12 w-12" aria-hidden="true">
                        <img class="rounded-full h-full w-full" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixqx=CcNlxnfZKX&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80h" alt="">
                      </div>
                  ...
                  <div class="hidden relative rounded-full overflow-hidden lg:block">
                    <img class="relative rounded-full w-40 h-40" src="https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixqx=CcNlxnfZKX&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=320&h=320&q=80" alt="">
              ...
              <div class="px-4 sm:px-6">
                ...
                <ul class="mt-2 divide-y divide-gray-200">
                  <li class="py-4 flex items-center justify-between">
                    ...
                    <toggle :aria="{ labelledby: 'privacy-option-1-label', describedby: 'privacy-option-1-description' }" />
                  </li>
                  <li class="py-4 flex items-center justify-between">
                    <div class="flex flex-col">
                    ...
                    <toggle :aria="{ labelledby: 'privacy-option-2-label', describedby: 'privacy-option-2-description' }" />
                  </li>
                  <li class="py-4 flex items-center justify-between">
                    <div class="flex flex-col">
                    ...
                    <toggle :aria="{ labelledby: 'privacy-option-3-label', describedby: 'privacy-option-3-description' }" />
                  </li>
                  <li class="py-4 flex items-center justify-between">
                    <div class="flex flex-col">
                    ...
                    <toggle :aria="{ labelledby: 'privacy-option-4-label', describedby: 'privacy-option-4-description' }" />
                  </li>
                </ul>
              </div>
