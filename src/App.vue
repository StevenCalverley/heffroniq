...
<div class="min-h-screen bg-gray-100">
  <header class="pb-24 bg-gradient-to-r ">
      ...
      <div class="relative flex flex-wrap items-center justify-center lg:justify-between">
        ...
        <div class="hidden lg:ml-4 lg:flex lg:items-center lg:py-5 lg:pr-0.5">
          ...
          <div class="ml-4 relative flex-shrink-0">
            <div>
              <button type="button" class="bg-white rounded-full flex text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100" id="user-menu" aria-haspopup="true">
