  ...
  <header class="pb-24 bg-gradient-to-r from-light-blue-800 to-cyan-600">
      ...
      <div class="relative flex flex-wrap items-center justify-center lg:justify-between">
        ...
        <div class="hidden lg:ml-4 lg:flex lg:items-center lg:py-5 lg:pr-0.5">
          ...
          <div class="ml-4 relative flex-shrink-0">
            <div>
              <button @click="openMenu = true" type="button" class="bg-white rounded-full flex text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100" id="user-menu" aria-haspopup="true">
            ...
            >
              <div v-show="openMenu" @click="openMenu = false" class="origin-top-right z-40 absolute -right-2 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
        ...
        <div class="absolute right-0 flex-shrink-0 lg:hidden">
          <!-- Mobile menu button -->
          <button class="bg-transparent p-2 rounded-md inline-flex items-center justify-center text-cyan-200 hover:text-white hover:bg-white hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-white" aria-expanded="false">
    ...
    <!--
      ...
      Leaving: "duration-150 ease-in"
        ...
        To: "opacity-0"
    -->
    <div class="z-20 fixed inset-0 bg-black bg-opacity-25 lg:hidden" aria-hidden="true"></div>
